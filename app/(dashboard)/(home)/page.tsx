...
import { BotIcon, HousePlus } from "lucide-react";
import Message from "@/app/components/message";
import type { Message as MessageType } from "@/lib/types/message";
import UserInput from "@/app/components/user-input";
...
export default function Home() {
  ...
  return (
    <div className="flex flex-col h-full w-full">
      <div className="flex items-center justify-between py-3 px-4 border-b border-border bg-background/80 backdrop-blur-sm sticky top-0 z-10">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-full bg-gradient-to-r from-primary to-primary/80 flex items-center justify-center shadow-sm">
